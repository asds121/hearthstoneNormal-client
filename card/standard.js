...
game.import("card", function () {
  return {
        ...
        content() {
          ...
          target
            ...
            .set("ai", function (card) {
              ...
              var bool = true;
              if (
                get.damageEffect(target, evt.player, target, evt.card.nature) >=
                0
              ) {
                bool = false;
              }
                  ...
                  if (target.identity === "fan") {
                    if (
                      ...
                      if (
                        num > dis ||
                        (player === target &&
                          player.countCards("hs", { type: "basic" }) >
                            1.6 * dis)
                      ) {
                        return 2;
                      }
              ...
              if (!event.directHit) {
                ...
                next.set(
                  ...
                  (() => {
                    ...
                    if (
                      get.attitude(responder, opposite._trueMe || opposite) >
                        0 &&
      ...
      qinglong_skill: {
        ...
        filter(event, player) {
          ...
          return (
            ...
            (player.hasSha() ||
              (_status.connectMode && player.countCards("hs")))
          );
        },
        content() {
          "step 0";
        ...
        content() {
          ...
          var next = player
            .chooseToDiscard(
              ...
              function (card, player) {
                ...
                return cards.some(
                  (cardx) =>
                    cardx !== card && !ui.selected.cards.includes(cardx)
                );
              }
            )
          ...
          next.set("ai", function (card) {
            ...
            if (get.attitude(evt.player, evt.target) < 0) {
              ...
              if (
                evt.baseDamage + evt.extraDamage >=
                Math.min(2, evt.target.hp)
              ) {
    ...
    translate: {
      ...
      guohe_bg: "拆",
      sha_info:
        "出牌阶段，对你攻击范围内的一名角色使用。其须使用一张【闪】，否则你对其造成1点伤害。",
      shan_info: "抵消一张【杀】。",
      tao_info:
      ...
      guanshi_info:
        "当你使用的【杀】被目标角色使用的【闪】抵消时，你可以弃置两张牌，令此【杀】依然对其造成伤害。",
      fangtian_skill_info:
        "你使用的【杀】若是你最后的手牌，你可以额外选择至多两个目标。",
      fangtian_info:
        "你使用的【杀】若是你最后的手牌，你可以额外选择至多两个目标。",
      nanman_info:
        "出牌阶段，对所有其他角色使用。每名目标角色需打出一张【杀】，否则受到1点伤害。",
      wanjian_info:
        "出牌阶段，对所有其他角色使用。每名目标角色需打出一张【闪】，否则受到1点伤害。",
      wuzhong_info: "出牌阶段，对你使用。你摸两张牌。",
      juedou_info:
        "出牌阶段，对一名其他角色使用。由其开始，其与你轮流打出一张【杀】，直到其中一方未打出【杀】为止。未打出【杀】的一方受到另一方对其造成的1点伤害。",
      shunshou_info:
        "出牌阶段，对距离为1且区域里有牌的一名其他角色使用。你获得其区域里的一张牌。",
      guohe_info:
        "出牌阶段，对区域里有牌的一名其他角色使用。你弃置其区域里的一张牌。",
